...
function App() {
  ...
  const apiKey = `AIzaSyDm5_Iqty6F-8bDo-8Fkj0h-DevABKrBc4`;

  // حط الـ driverId اللي هتختبر عليه (مثال: بتاع الـ driver-sim)
  const [driverId, setDriverId] = useState(
    "200403c4-177a-44d3-8e2c-2bdc9769f0a1"
  );
  return (
    <div
      style={{
    ...
    >
      <h2 style={{ margin: 0 }}>Live Trip Tracking — Test Mode</h2>

      {/* ادخل driverId للتجربة السريعة */}
      ...
      {/* الخريطة */}
      <DriverMap driverId={driverId} apiKey={apiKey} />
    </div>
  );
